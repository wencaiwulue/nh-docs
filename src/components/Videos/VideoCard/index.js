...
const ProductVideoCards = [
    ...
    {
        url: 'http://player.bilibili.com/player.html?aid=716660126&bvid=BV1RX4y1w7hB&cid=369570676&page=1',
        title: 'Nocalhost 概览',
        language: 'zh-cn',
        description: (
          <>
        ...
        <div className="margin-top--lg">
            <div className="container">
                <section className="video-section">
                    ...
                    <div className="row">
                        {ProductVideoCards.map((props, idx) => (
                            <Card key={idx} {...props} />
                        ))}
                    </div>
                </section>
                <section className="video-section">
                    <h2>Tutorials</h2>
                    <div className="row">
                        {TutorialVideoCards.map((props, idx) => (
                            <Card key={idx} {...props} />
                        ))}
                    </div>
                </section>
